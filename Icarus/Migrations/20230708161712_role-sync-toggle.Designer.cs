...
namespace Icarus.Migrations
{
    ...
    [Migration("20230708161712_role-sync-toggle")]
    partial class rolesynctoggle
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Icarus.Context.Models.StaffAction", b =>
                {
                    b.Property<long>("StaffActionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("StaffActionId"));
            ...
            modelBuilder.Entity("Icarus.Context.Models.StaffActionChannel", b =>
                {
            ...
            modelBuilder.Entity("Icarus.Context.Models.StaffAction", b =>
                {
                    b.HasOne("Icarus.Context.Models.DiscordUser", "AssignedTo")
                        .WithMany("AssignedStaffActions")
                        .HasForeignKey("AssignedToId");

                    b.HasOne("Icarus.Context.Models.DiscordUser", "Submitter")
            ...
            modelBuilder.Entity("Icarus.Context.Models.DiscordUser", b =>
                {
                    b.Navigation("AssignedStaffActions");

                    b.Navigation("Characters");

                    b.Navigation("CreatedStaffActions");
                });
